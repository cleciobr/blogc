...
<div id="principal">
<table  style="border:0px solid black; width:591px; height:98px; background-image:url('images/AssShineray2021c.png'); position:absolute; top: 100px; left: 230px;"  cellpadding="0" cellspacing="0" align="left" valign="baseline">
<tr>
	...
	<td height="26" colspan="5">
		<?php 
			...
			echo ("<br>");
			echo ("<span class='setorSHI' >&nbsp".$setor_select["NOME_SETOR"]."</span>");
