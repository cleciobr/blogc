...
// $app->GET("/admin/searchpatient", function() {
// 	User::verifyLogin();
// 	User::verifyAccess() 
// 	$user = User::getFromSession();
	
//     $page = new PageAdmin();
// 	$page->setTpl("searchpatient", array(
// 		"user" => $user->getValues()
// 	));
// });

// $app->GET("/admin/searchpatient/result", function() use ($app) {
//     User::verifyLogin();
//     User::verifyAccess();
//     $user = User::getFromSession();

// 	$searchText = strtoupper($app->request()->get('searchText'));
// 	$searchpatient = Searchpatient::search($searchText);
//     $page = new PageAdmin();
//     $page->setTpl("searchpatientdone", array(
...
// // GET
// $app->get("/admin/patientsd(/)", function() {
// 	User::verifyLogin();
// 	User::verifyAccess();
// 	$user = new User();
// 	$user = User::getFromSession();
...
// $app->get("/admin/patientsdgs/create2(/)", function() {
...
// $app->post("/admin/patientsdgs/create2(/)", function() {
// 	User::verifyLogin();
// 	User::verifyAccess();
// 	$patientdgs = new Patientdgs();
